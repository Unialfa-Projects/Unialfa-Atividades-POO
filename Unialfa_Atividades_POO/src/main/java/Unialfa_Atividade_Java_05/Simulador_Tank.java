...
package Unialfa_Atividade_Java_05;

import java.util.Scanner;
import static java.lang.Math.sin;

public class Simulador_Tank {
    ...
    public static double lerAngulo(Scanner scanner) {
        while (true) {
            System.out.print("Digite o angulo de lancamento (0 a 90 graus): ");
            if (scanner.hasNextDouble()) {
                ...
                if (angulo > 0 && angulo < 90) {
                    ...
                    System.out.println("Angulo deve ser entre 0 e 90 graus (exclusivo).");
                }
            } else {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.printf(
                "Para velocidade inicial = %.1f m/s e angulo = %.1f°, o alcance e de %.2f km.%n",
